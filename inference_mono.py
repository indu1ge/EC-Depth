...
def evaluate(opt):
    ...
    if opt.ext_disp_to_eval is None:
        ...
        filenames = readlines("./data/icra/test.txt")
        ...
        dataset = datasets.ICRADataset(opt.data_path, filenames,
                                       encoder_dict['height'], encoder_dict['width'],
                                        [0], 4,
                                        is_train=False,
                                        load_pose=False,
        ...
        with torch.no_grad():
            ...
            for data in dataloader:
                ...
                output_path = os.path.join(opt.eval_out_dir, filenames[i].split('/')[-1])
