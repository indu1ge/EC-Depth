...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--augmix",
                                 help="if set will use augmix from the ICLR 2020 paper",
                                 action="store_true")
        self.parser.add_argument("--fp",
                                 help="if set will perform feature perturbation",
                                 action="store_true")
        self.parser.add_argument("--aug_fp",
                                 help="if set will perform feature perturbation on augmix",
                                 action="store_true")
